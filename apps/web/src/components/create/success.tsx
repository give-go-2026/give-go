    ...
    <section className='mx-auto flex w-full max-w-416 flex-col gap-4 px-3 py-4 md:gap-6 md:px-28 md:py-5'>
      <div className='bg-background -mt-34 mb-5 flex w-full flex-col justify-between rounded-3xl px-4 py-6 shadow-xl shadow-black/15 md:-mb-11.5'>
        ...
        <p className='mb-5'>
          ...
          módosítani, amit a publikásig tudsz megtenni (utána már csak törölni tudod az eseményt). A
          második linkkel a hirdetésed előnézetét tudod megnézni.
        </p>
        ...
        <div className='flex items-center justify-between'>
          <div className='w-20 text-center font-bold'>
            <Link href='/create/info'>vissza</Link>
          </div>
          <div className='w-max'>
            <Button
              styleType='primary'
